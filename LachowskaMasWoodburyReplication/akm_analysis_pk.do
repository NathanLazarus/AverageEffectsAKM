...
graph save Graph "AKM_earnings_pk.gph", replace
...
graph save Graph "AKM_hours_pk.gph", replace
...
graph save Graph "AKM_wage_pk.gph", replace


*******************
/// Figure A4-4  ///
*******************
grc1leg "AKM_earnings_pk.gph" "AKM_hours_pk.gph" "AKM_wage_pk.gph" ,  cols(2) 
graph save Graph "FigureA4_4.gph", replace

erase "AKM_earnings_pk.gph" 
erase "AKM_hours_pk.gph" 
erase "AKM_wage_pk.gph"
